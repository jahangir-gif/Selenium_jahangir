...
@Listeners(selenium.Listeners_types.class)
public class Listeners_class {
	...
	public void sampleTest1() throws InterruptedException {
		...
		waitforbutton.until(ExpectedConditions.presenceOfElementLocated(
				By.xpath("//div[contains(text(),'  Enter your email or mobile phone number')]")));
		waitforbutton.until(
